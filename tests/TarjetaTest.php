...
class EstacionTest extends TestCase {
    ...
    public function testViaje() {
        ...
        $this->assertEquals($tarjeta->viajes_realizados->obtener_tipo(),'Normal');
        $this->assertEquals($tarjeta->viajes_realizados->obtener_monto(),9.75);
        $this->assertEquals($tarjeta->viajes_realizados->obtener_transporte(),145);
